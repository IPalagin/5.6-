...
internal class Program
{
    ...
    static (string Name, string Famaly, byte Age, bool isPets, string[] petArr, string[] colorArr) anketa;
    static void ReturnCort(ref byte petNumb, ref byte colorNumb)
    {
        ...
        if (result == "Да")
        {
            ...
            anketa.petArr = NumPetsName(ref petNumb);
        }
        else
        {
            anketa.isPets = false;
        ...
        anketa.colorArr = NumColor(ref colorNumb);
    }
